...
`    /* §R18.28 · DEFESA DE CRUZAMENTO É ZONAL. Com a bola aberta no terço final
    ...
    if (_ameaca > ${LIMIAR} && p !== presser && p !== tm._cover) {
      ...
      this.__zonalCenso=this.__zonalCenso||{elegivel:0,def:0,mid:0,outro:{}};
      this.__zonalCenso.elegivel++;
      if(_ln==='DEF')this.__zonalCenso.def++; else if(_ln==='MID')this.__zonalCenso.mid++; else this.__zonalCenso.outro[String(_ln)]=(this.__zonalCenso.outro[String(_ln)]||0)+1;
