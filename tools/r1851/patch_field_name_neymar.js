...
'use strict';
/*
 * NOME DE CAMPO · NEYMAR
 * ----------------------
 * O rotulo do jogador em campo vem de `lastWord(name, max)`, que devolve a
 * ULTIMA palavra do nome de registro em maiusculas. "Neymar Santos Junior"
 * virava "JUNIOR".
 *
 * A troca e feita SO na camada de exibicao. O nome de dados continua
 * "Neymar Santos Junior" porque ele e semente em `hash32(p.n + '#' + key)`
 * (build R18.50:2807 e :2817), que gera o jitter dos atributos. Reescrever o
 * dado mudaria os atributos do jogador e, com eles, o resultado das partidas —
 * quebrando o pareamento deterministico das baterias.
 *
