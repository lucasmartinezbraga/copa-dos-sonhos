...
'use strict';
/*
 * CADEIA DE BUILD DA R18.99  (CANDIDATA)  ·  CANDIDATA, **NAO PROMOVIDA**
 * =========================================================
 * A build promovida continua sendo a R18.97 (build_r1897.js).
 * Esta cadeia REPROVOU na bateria oficial: gols 2,1076 de media, mas
 * 1,6458 na base 8400000 contra um piso de 1,8. Cinco das seis bases
 * melhoraram e a media subiu -- a atribuicao entre as edicoes da rodada
 * ainda estava em medicao quando isto foi escrito.
 * Ver reports/r1896/RODADA_OS111_OS112_ESPERA_E_LATERAL.md.
 *
...
const SAIDA = (process.argv[2] && !process.argv[2].startsWith('--'))
  ? process.argv[2] : path.resolve(AQUI, '..', 'R18.99.html');
...
const CADEIA = [
  ...
  ['OS-112', 'patch_os112_lateral_saida_e_apoio.js'],
  ['OS-113', 'patch_os113_falta_cartao_e_hud.js'],
  ['OS-114', 'patch_os114_camera_ve_a_bola_fora.js'],
];
